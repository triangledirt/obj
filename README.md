...
These 14 properties are a fingerprint of the inference landscape. Their meanings are [explained](https://github.com/triangledirt/alib#infer-from-set-to-set) later.
